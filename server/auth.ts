...
export function setupAuth(app: Express) {
  // Use a reasonable secret or load from env variable
  const sessionSecret = process.env.SESSION_SECRET || "investflow-session-secret";
  ...
  passport.use(
    new LocalStrategy(async (username, password, done) => {
      try {
        // Try to find user by email (as username) first
