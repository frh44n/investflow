...
import CustomerAssistanceModal from "./customer-assistance-modal";
import AccountSettingsModal from "./account-settings-modal";

export default function MenuOptions() {
  const { logoutMutation, user } = useAuth();
  const [location, navigate] = useLocation();
  const [showCustomerAssistance, setShowCustomerAssistance] = useState(false);
  ...
  const options = [
    ...
    },
    {
      ...
      onClick: () => setShowCustomerAssistance(true),
    },
    {
